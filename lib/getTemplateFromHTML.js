/**
 * Extract templates from HTML and assign the result
 * @param {string} html
 * @param {Object} [templates={}]
 * @returns {Object.<string, string>}
 */
function getTemplateFromHTML (html, templates = {}) {
  ...
  for (const match of matches) {
    ...
    if (currentId === null) {
      ...
      // set component value
      templates[currentId] = match.input.slice(startIndex, match.index)
      // clear current id
      currentId = null
    }
  }
