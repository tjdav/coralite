...
Coralite.prototype._moduleLinker = function (path) {
  ...
  return async (specifier, referencingModule, extra) => {
    if (specifier === 'coralite') {
      return new SourceTextModule(this._options.source.modules.coralite.export + this._options.source.modules.coralite.default, {
        context: referencingModule.context
      })
    } else if (specifier == 'coralite/plugins') {
      return new SourceTextModule(this._options.source.modules.plugins.export + this._options.source.modules.plugins.default, {
        context: referencingModule.context
      })
