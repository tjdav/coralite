...
- 8999339 (HEAD -> main, tag: v0.9.0, origin/main) docs: Update Coralite initialization syntax and parameter documentation - ([Thomas David](https://codeberg.org/tjdavid))
